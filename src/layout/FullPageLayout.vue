  ...
  <div class="index-page">
      ...
      <div class="topbar d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
          ...
          <div class="social-links d-none d-md-flex align-items-center">
            <a href="#" class="twitter"><i class="bi bi-twitter-x" /></a>
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
          ...
          <nav id="navmenu" class="navmenu">
            <ul>
              ...
              <li class="dropdown">
                <a href="#"><span>Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown" /></a>
                <ul>
                  <li><a href="#">Dropdown 1</a></li>
                  <li class="dropdown">
                    <a href="#"><span>Deep Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown" /></a>
                    <ul>
          ...
          <div class="content row gy-4">
              ...
              <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
                ...
                <div class="text-center">
                  <a href="#about" class="more-btn">
                    <span>Learn More</span> <i class="bi bi-chevron-right" />
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-8 d-flex align-items-stretch">
              <div class="d-flex flex-column justify-content-center">
                <div class="row gy-4">
                  <div
                    v-for="(box, i) in iconBoxes"
                    :key="i"
                    class="col-xl-4 d-flex align-items-stretch"
                  >
                    <div class="icon-box" :data-aos-delay="box.delay" data-aos="zoom-out">
                      <i :class="box.icon" />
                      <h4>{{ box.title }}</h4>
                      <p>{{ box.text }}</p>
                    </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
              ...
              <div class="stats-item">
                <span data-purecounter-start="0" data-purecounter-end="150" data-purecounter-duration="1" class="purecounter" />
                <p>Awards</p>
              </div>
            </div><!-- End Stats Item -->
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
            <div class="row">
              ...
              <div class="col-md-4 form-group mt-3 mt-md-0">
                <input id="phone" type="tel" class="form-control" name="phone" placeholder="Your Phone" required="">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 form-group mt-3">
                <input id="date" type="datetime-local" name="date" class="form-control datepicker" placeholder="Appointment Date" required="">
              </div>
              <div class="col-md-4 form-group mt-3">
            ...
            <div class="form-group mt-3">
              <textarea class="form-control" name="message" rows="5" placeholder="Message (Optional)" />
            </div>
            <div class="mt-3">
          ...
          <div class="row">
            ...
            <div class="col-lg-9 mt-4 mt-lg-0">
              <div class="tab-content">
                <div id="departments-tab-1" class="tab-pane active show">
                  <div class="row">
                ...
                <div id="departments-tab-2" class="tab-pane">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div id="departments-tab-3" class="tab-pane">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div id="departments-tab-4" class="tab-pane">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div id="departments-tab-5" class="tab-pane">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
            ...
            <div class="col-lg-10" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="faq-container">
                ...
                <div class="faq-item faq-active">
                  ...
                  <i class="faq-toggle bi bi-chevron-right" />
                </div><!-- End Faq item-->
    ...
    <footer id="footer" class="footer light-background">
      ...
      <div class="container copyright text-center mt-4">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">Medilab</strong> All Rights Reserved</p>
        <div class="credits">
